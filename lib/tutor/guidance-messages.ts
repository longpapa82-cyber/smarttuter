...
import { GuidanceMessages, Subject, GradeLevel } from '@/types/tutor';
...
export const guidanceMessages: GuidanceMessages = {
  elementary: {
    tooAdvanced: {
      ...
      science: [
        '🔬 정말 흥미로운 질문이에요! 하지만 이 과학 개념은 {학생 이름}가 중학교에 가면 배우게 될 내용이에요. 지금은 {현재 학년 적절한 개념}을 먼저 탐구해볼까요? 과학은 기초가 탄탄해야 나중에 더 재미있어져요!',
        '🌟 {학생 이름}의 과학적 호기심이 정말 대단해요! 그런데 이건 조금 더 자란 후에 배우는 내용이에요. 지금 우리는 {관련된 기초 과학 개념}을 배우고 있는데, 이것부터 차근차근 알아볼까요?',
        '⚗️ 와, 고급 과학 질문이네요! 그런데 이것은 중학생이나 고등학생이 실험하고 배우는 내용이에요. 지금은 {기초 과학 개념}을 확실하게 이해하는 것이 더 중요해요. 함께 신나게 과학 탐구해볼까요?'
      ]
    }
  },
  ...
  middle: {
    tooAdvanced: {
      ...
      science: [
        '🔬 훌륭한 질문이에요! 이 과학 주제는 고등학교에서 다루는 내용인데, {학생 이름}가 벌써 관심을 가지다니 놀라워요. 지금 단계에서는 {중학교 수준 과학 개념}을 이해하는 게 먼저예요. 이걸 잘 다지면 나중에 그 심화 개념도 훨씬 쉽게 이해할 수 있을 거예요!',
        '⚗️ 정말 의욕이 넘치네요! 하지만 이 과학 개념은 아직 중학생에게는 조금 어려워요. 대신 {관련 기초 과학 개념}을 먼저 완벽하게 익혀볼까요? 그게 바로 그 고급 과학으로 가는 지름길이에요!',
        '🧪 미래 지향적인 질문이네요! 그런데 이것은 고등학교 과학 과정이에요. 지금은 {현재 학습 단계 과학 개념}을 확실히 하는 것이 중요합니다. 이것만 잘 해도 고등학교에서 훨씬 수월할 거예요.'
      ]
    }
  },
  ...
  high: {
    tooAdvanced: {
      ...
      science: [
        '🔬 흥미로운 질문입니다! 이 과학 주제는 대학에서 다루는 전문적인 내용인데, 고등학교 과정과 연결해서 생각해보면 {고등학교 과학 개념 연결} 부분을 먼저 확실히 이해하는 것이 중요합니다. 대학 과정에 대한 호기심을 갖는 건 훌륭하지만, 수능/내신에서 다루는 과학 범위를 먼저 완벽하게 하는 것이 좋습니다.',
        '⚗️ 대학 수준의 과학 질문이네요! 현재 고등학교 교육과정에서는 이 부분이 포함되지 않습니다. 하지만 {관련 고등 과학 개념}을 깊이 이해하면, 대학에서 이 주제를 배울 때 훨씬 수월할 겁니다. 먼저 그 부분을 탐구해볼까요?',
        '🧪 선행학습에 대한 의지가 대단하네요! 하지만 이것은 대학 전공 과학 내용입니다. 고등학교 과정의 {해당 과학 영역}을 완벽하게 마스터하는 것이 더 효율적입니다. 그 다음 단계로 자연스럽게 연결될 거예요.'
      ]
    }
  },
  ...
  university: {
    tooAdvanced: {
      ...
      science: [
        '🔬 이 과학 분야는 제가 전문적으로 다루기에는 한계가 있습니다. {관련 전공/분야}의 전문가나 교수님께 문의하시는 것을 추천드립니다. 제가 도울 수 있는 {가능한 과학 영역}에 대해서는 최선을 다하겠습니다.',
        '⚗️ 솔직히 말씀드리면, 이 과학 질문은 제 전문 영역을 벗어납니다. 하지만 기본적인 접근 방법이나 {관련 기초 과학 개념}에 대해서는 함께 탐구해볼 수 있습니다.',
        '🧪 이것은 매우 전문적인 연구 수준의 과학 질문이네요. 저는 기초부터 학부 수준까지 도와드릴 수 있지만, 이 수준은 전문 연구자나 지도교수님과 논의하시는 것이 더 적절할 것 같습니다.'
      ]
    },
    outOfExpertise: {
      honest: [
