...
function FeatureCard({ title, description, icon, gradient, href, size, badge }: FeatureCardProps) {
  const sizeClasses = {
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className={`relative group ${sizeClasses[size]} h-full min-h-[200px] rounded-3xl p-6 sm:p-8 ${gradient} overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all`}
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
          ...
          {/* Arrow indicator */}
          <div className="mt-4 sm:mt-6 flex items-center text-white/80 text-sm font-medium group-hover:text-white transition-colors">
            <span>자세히 보기</span>
