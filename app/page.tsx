      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">SmartTuter</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white">영어 튜터</a></li>
                <li><a href="#" className="hover:text-white">수학 튜터</a></li>
                <li><a href="#" className="hover:text-white">학습 리포트</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 SmartTuter. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
